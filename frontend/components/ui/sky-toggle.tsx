...
const SkyToggle = () => {
  ...
  // Avoid hydration mismatch by not rendering the interactive toggle until mounted
  if (!mounted) return <div className="w-[60px] h-[25px]" />; 
    ...
    <StyledWrapper>
      <label className="theme-switch">
        <input 
          ...
          // Checked when theme is NOT dark (because input:checked usually means "on/light")
          // In your CSS logic: checked = night-bg. So we align:
          checked={isDark} 
...
// StyledWrapper stays exactly as you have it
